!function (e, t) {
    ...
    var n = [], r = n.slice, i = n.concat, o = n.push, a = n.indexOf, s = {}, l = s.toString, u = s.hasOwnProperty,
        ...
        }, d = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, p = /^-ms-/, h = /-([\da-z])/gi, m = function (e, t) {
            return t.toUpperCase()
        };
    f.fn = f.prototype = {
        jquery: "1.11.3", constructor: f, selector: "", length: 0, toArray: function () {
            return r.call(this)
        }, get: function (e) {
        ...
        for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || f.isFunction(a) || (a = {}), s === l && (a = this, s--); s < l; s++) if (null != (i = arguments[s])) for (r in i) e = a[r], a !== (n = i[r]) && (u && n && (f.isPlainObject(n) || (t = f.isArray(n))) ? (t ? (t = !1, o = e && f.isArray(e) ? e : []) : o = e && f.isPlainObject(e) ? e : {}, a[r] = f.extend(u, o, n)) : void 0 !== n && (a[r] = n));
        return a
    }, f.extend({
        expando: "jQuery" + ("1.11.3" + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
            ...
            if (g(e)) for (; o < a; o++) null != (r = t(e[o], o, n)) && s.push(r); else for (o in e) null != (r = t(e[o], o, n)) && s.push(r);
            return i.apply([], s)
    ...
    function g(e) {
        var t = "length" in e && e.length, n = f.type(e);
        return "function" !== n && !f.isWindow(e) && (!(1 !== e.nodeType || !t) || ("array" === n || 0 === t || "number" == typeof t && t > 0 && t - 1 in e))
    }

    var v = function (e) {
        var t, n, r, i, o, a, s, l, u, c, f, d, p, h, m, g, v, y, b, x = "sizzle" + 1 * new Date, w = e.document, T = 0,
        ...
        n = oe.support = {}, o = oe.isXML = function (e) {
            ...
            if ((e.ownerDocument || e) !== p && d(e), t = t.replace(U, "='$1']"), n.matchesSelector && m && (!v || !v.test(t)) && (!g || !g.test(t))) try {
                var r = y.call(e, t);
        ...
        for (t in{radio: !0, checkbox: !0, file: !0, password: !0, image: !0}) r.pseudos[t] = (pe = t, function (e) {
            return "input" === e.nodeName.toLowerCase() && e.type === pe
        });
        var pe;
        for (t in{submit: !0, reset: !0}) r.pseudos[t] = (he = t, function (e) {
            var t = e.nodeName.toLowerCase();
        ...
        me.prototype = r.filters = r.pseudos, r.setFilters = new me, a = oe.tokenize = function (e, t) {
            ...
            return r && !r[x] && (r = xe(r)), i && !i[x] && (i = xe(i, o)), se(function (o, a, s, l) {
                ...
                if (o) {
                    if (i || e) {
                        ...
                        for (c = v.length; c--;) (f = v[c]) && (u = i ? M(o, f) : d[c]) > -1 && (o[u] = !(a[u] = f))
                    }
        ...
        function we(e) {
            for (var t, n, i, o = e.length, a = r.relative[e[0].type], s = a || r.relative[" "], l = a ? 1 : 0, c = ve(function (e) {
                ...
                return t = null, i
            }]; l < o; l++) if (n = r.relative[e[l].type]) d = [ve(ye(d), n)]; else {
                if ((n = r.filter[e[l].type].apply(null, e[l].matches))[x]) {
                    for (i = ++l; i < o && !r.relative[e[i].type]; i++) ;
                    return xe(l > 1 && ye(d), l > 1 && ge(e.slice(0, l - 1).concat({value: " " === e[l - 2].type ? "*" : ""})).replace(z, "$1"), n, l < i && we(e.slice(l, i)), i < o && we(e = e.slice(i)), i < o && ge(e))
                }
                d.push(n)
            }
            return ye(d)
        ...
        return s = oe.compile = function (e, t) {
            ...
            if (i = i || [], 1 === h.length) {
                ...
                for (l = Y.needsContext.test(e) ? 0 : u.length; l-- && (c = u[l], !r.relative[f = c.type]);) if ((d = r.find[f]) && (o = d(c.matches[0].replace(ne, re), ee.test(u[0].type) && de(t.parentNode) || t))) {
                    if (u.splice(l, 1), !(e = o.length && ge(u))) return q.apply(i, o), i;
                    break
                }
            }
            return (p || s(e, h))(o, t, !m, i, ee.test(e) && de(t.parentNode) || t), i
    ...
    var y = f.expr.match.needsContext, b = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, x = /^.[^:#\[\.,]*$/;
    ...
    f.filter = function (e, t, n) {
        ...
        find: function (e) {
            ...
            return !!w(this, "string" == typeof e && y.test(e) ? f(e) : e || [], !1).length
        }
    });
    var T, C = e.document, N = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
    (f.fn.init = function (e, t) {
        ...
        if ("string" == typeof e) {
            ...
            if (n[1]) {
                if (t = t instanceof f ? t[0] : t, f.merge(this, f.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : C, !0)), b.test(n[1]) && f.isPlainObject(t)) for (n in t) f.isFunction(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
                return this
            }
    ...
    f.extend({
        ...
        has: function (e) {
            ...
            for (var n, r = 0, i = this.length, o = [], a = y.test(e) || "string" != typeof e ? f(e, t || this.context) : 0; r < i; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (a ? a.index(n) > -1 : 1 === n.nodeType && f.find.matchesSelector(n, e))) {
                o.push(n);
                break
            }
    ...
    f.Callbacks = function (e) {
        var t, n, r, i, o, a, s = [], l = !(e = "string" == typeof e ? D[e] || function (e) {
            var t = D[e] = {};
            return f.each(e.match(A) || [], function (e, n) {
                t[n] = !0
            }), t
        }(e) : f.extend({}, e)).once && [], u = function (f) {
            for (n = e.memory && f, r = !0, o = a || 0, a = 0, i = s.length, t = !0; s && o < i; o++) if (!1 === s[o].apply(f[0], f[1]) && e.stopOnFalse) {
                n = !1;
                break
            }
            ...
            add: function () {
                ...
                return s && f.each(arguments, function (e, n) {
                    for (var r; (r = f.inArray(n, s, r)) > -1;) s.splice(r, 1), t && (r <= i && i--, r <= o && o--)
                }), this
            }, has: function (e) {
        ...
        Deferred: function (e) {
            ...
            var t, n, i, o = 0, a = r.call(arguments), s = a.length,
                l = 1 !== s || e && f.isFunction(e.promise) ? s : 0, u = 1 === l ? e : f.Deferred(),
                c = function (e, n, i) {
                    return function (o) {
                        n[e] = this, i[e] = arguments.length > 1 ? r.call(arguments) : o, i === t ? u.notifyWith(n, i) : --l || u.resolveWith(n, i)
                    }
                };
            if (s > 1) for (t = new Array(s), n = new Array(s), i = new Array(s); o < s; o++) a[o] && f.isFunction(a[o].promise) ? a[o].promise().done(c(o, i, a)).fail(u.reject).progress(c(o, n, t)) : --l;
    ...
    f.fn.ready = function (e) {
        ...
        isReady: !1, readyWait: 1, holdReady: function (e) {
            ...
            if (!0 === e ? !--f.readyWait : !f.isReady) {
                ...
                f.isReady = !0, !0 !== e && --f.readyWait > 0 || (j.resolveWith(C, [f]), f.fn.triggerHandler && (f(C).triggerHandler("ready"), f(C).off("ready")))
            }
        }
    });
    ...
    f.ready.promise = function (t) {
        if (!j) if (j = f.Deferred(), "complete" === C.readyState) setTimeout(f.ready); else if (C.addEventListener) C.addEventListener("DOMContentLoaded", H, !1), e.addEventListener("load", H, !1); else {
    ...
    function P(e, t, r, i) {
        if (f.acceptData(e)) {
            var o, a, s = f.expando, l = e.nodeType, u = l ? f.cache : e, c = l ? e[s] : e[s] && s;
            if (c && u[c] && (i || u[c].data) || void 0 !== r || "string" != typeof t) return c || (c = l ? e[s] = n.pop() || f.guid++ : s), u[c] || (u[c] = l ? {} : {toJSON: f.noop}), "object" != typeof t && "function" != typeof t || (i ? u[c] = f.extend(u[c], t) : u[c].data = f.extend(u[c].data, t)), a = u[c], i || (a.data || (a.data = {}), a = a.data), void 0 !== r && (a[f.camelCase(t)] = r), "string" == typeof t ? null == (o = a[t]) && (o = a[f.camelCase(t)]) : o = a, o
        }
    }

    function R(e, t, n) {
        if (f.acceptData(e)) {
            var r, i, o = e.nodeType, a = o ? f.cache : e, s = o ? e[f.expando] : f.expando;
            if (a[s]) {
    ...
    f.extend({
        ...
        data: function (e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (i = f.data(o), 1 === o.nodeType && !f._data(o, "parsedAttrs"))) {
                    for (n = a.length; n--;) a[n] && 0 === (r = a[n].name).indexOf("data-") && O(o, r = f.camelCase(r.slice(5)), i[r]);
        ...
        queue: function (e, t) {
            ...
            var n, r = 1, i = f.Deferred(), o = this, a = this.length, s = function () {
                --r || i.resolveWith(o, [o])
            };
    ...
    var W = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, $ = ["Top", "Right", "Bottom", "Left"], z = function (e, t) {
    ...
    var U = /^(?:input|select|textarea)$/i, V = /^key/, J = /^(?:mouse|pointer|contextmenu)|click/,
        Y = /^(?:focusinfocus|focusoutblur)$/, G = /^([^.]*)(?:\.(.+)|)$/;
    ...
    f.event = {
        ...
        add: function (e, t, n, r, i) {
            ...
            if (v) {
                for (n.handler && (n = (l = n).handler, i = l.selector), n.guid || (n.guid = f.guid++), (a = v.events) || (a = v.events = {}), (c = v.handle) || ((c = v.handle = function (e) {
                    return typeof f === _ || e && f.event.triggered === e.type ? void 0 : f.event.dispatch.apply(c.elem, arguments)
                }).elem = e), s = (t = (t || "").match(A) || [""]).length; s--;) h = g = (o = G.exec(t[s]) || [])[1], m = (o[2] || "").split(".").sort(), h && (u = f.event.special[h] || {}, h = (i ? u.delegateType : u.bindType) || h, u = f.event.special[h] || {}, d = f.extend({
                    type: h,
                    origType: g,
                    data: r,
                    handler: n,
        ...
        remove: function (e, t, n, r, i) {
            ...
            if (v && (c = v.events)) {
                for (u = (t = (t || "").match(A) || [""]).length; u--;) if (h = g = (s = G.exec(t[u]) || [])[1], m = (s[2] || "").split(".").sort(), h) {
        ...
        trigger: function (t, n, r, i) {
            var o, a, s, l, c, d, p, h = [r || C], m = u.call(t, "type") ? t.type : t,
                g = u.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = d = r = r || C, 3 !== r.nodeType && 8 !== r.nodeType && !Y.test(m + f.event.triggered) && (m.indexOf(".") >= 0 && (m = (g = m.split(".")).shift(), g.sort()), a = m.indexOf(":") < 0 && "on" + m, (t = t[f.expando] ? t : new f.Event(m, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = g.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : f.makeArray(n, [t]), c = f.event.special[m] || {}, i || !c.trigger || !1 !== c.trigger.apply(r, n))) {
                ...
                for (p = 0; (s = h[p++]) && !t.isPropagationStopped();) t.type = p > 1 ? l : c.bindType || m, (o = (f._data(s, "events") || {})[t.type] && f._data(s, "handle")) && o.apply(s, n), (o = a && s[a]) && o.apply && f.acceptData(s) && (t.result = o.apply(s, n), !1 === t.result && t.preventDefault());
        ...
        dispatch: function (e) {
            e = f.event.fix(e);
            var t, n, i, o, a, s = [], l = r.call(arguments), u = (f._data(this, "events") || {})[e.type] || [],
        ...
        var r = "on" + t;
        e.detachEvent && (typeof e[r] === _ && (e[r] = null), e.detachEvent(r, n))
    ...
    }), c.focusinBubbles || f.each({focus: "focusin", blur: "focusout"}, function (e, t) {
        var n = function (e) {
            f.event.simulate(t, e.target, f.event.fix(e), !0)
        };
        f.event.special[t] = {
            setup: function () {
                var r = this.ownerDocument || this, i = f._data(r, t);
                i || r.addEventListener(e, n, !0), f._data(r, t, (i || 0) + 1)
            }, teardown: function () {
                var r = this.ownerDocument || this, i = f._data(r, t) - 1;
    ...
    var te = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        ne = / jQuery\d+="(?:null|\d+)"/g, re = new RegExp("<(?:" + te + ")[\\s/>]", "i"), ie = /^\s+/,
        ...
        fe = /^$|\/(?:java|ecma)script/i, de = /^true\/(.*)/, pe = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, he = {
    ...
    function ge(e, t) {
        var n, r, i = 0,
            o = typeof e.getElementsByTagName !== _ ? e.getElementsByTagName(t || "*") : typeof e.querySelectorAll !== _ ? e.querySelectorAll(t || "*") : void 0;
        if (!o) for (o = [], n = e.childNodes || e; null != (r = n[i]); i++) !t || f.nodeName(r, t) ? o.push(r) : f.merge(o, ge(r, t));
    ...
    function Te(e, t) {
        if (1 === t.nodeType && f.hasData(e)) {
            var n, r, i, o = f._data(e), a = f._data(t, o), s = o.events;
            if (s) {
                delete a.handle, a.events = {};
                for (n in s) for (r = 0, i = s[n].length; r < i; r++) f.event.add(t, n, s[n][r])
            }
    ...
    f.extend({
        clone: function (e, t, n) {
            ...
            if (c.html5Clone || f.isXMLDoc(e) || !re.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (me.innerHTML = e.outerHTML, me.removeChild(o = me.firstChild)), !(c.noCloneEvent && c.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || f.isXMLDoc(e))) for (r = ge(o), s = ge(e), a = 0; null != (i = s[a]); ++a) r[a] && Ce(i, r[a]);
            if (t) if (n) for (s = s || ge(e), r = r || ge(o), a = 0; null != (i = s[a]); a++) Te(i, r[a]); else Te(e, o);
            return (r = ge(o, "script")).length > 0 && we(r, !l && ge(e, "script")), r = s = i = null, o
        }, buildFragment: function (e, t, n, r) {
            for (var i, o, a, s, l, u, d, p = e.length, h = ee(t), m = [], g = 0; g < p; g++) if ((o = e[g]) || 0 === o) if ("object" === f.type(o)) f.merge(m, o.nodeType ? [o] : o); else if (le.test(o)) {
                ...
                if (!c.leadingWhitespace && ie.test(o) && m.push(t.createTextNode(ie.exec(o)[0])), !c.tbody) for (i = (o = "table" !== l || se.test(o) ? "<table>" !== d[1] || se.test(o) ? 0 : s : s.firstChild) && o.childNodes.length; i--;) f.nodeName(u = o.childNodes[i], "tbody") && !u.childNodes.length && o.removeChild(u);
                for (f.merge(m, s.childNodes), s.textContent = ""; s.firstChild;) s.removeChild(s.firstChild);
                s = h.lastChild
            } else m.push(t.createTextNode(o));
            for (s && h.removeChild(s), c.appendChecked || f.grep(ge(m, "input"), ve), g = 0; o = m[g++];) if ((!r || -1 === f.inArray(o, r)) && (a = f.contains(o.ownerDocument, o), s = ge(h.appendChild(o), "script"), a && we(s), n)) for (i = 0; o = s[i++];) fe.test(o.type || "") && n.push(o);
            return s = null, h
        }, cleanData: function (e, t) {
            for (var r, i, o, a, s = 0, l = f.expando, u = f.cache, d = c.deleteExpando, p = f.event.special; null != (r = e[s]); s++) if ((t || f.acceptData(r)) && (a = (o = r[l]) && u[o])) {
                if (a.events) for (i in a.events) p[i] ? f.event.remove(r, i) : f.removeEvent(r, i, a.handle);
                u[o] && (delete u[o], d ? delete r[l] : typeof r.removeAttribute !== _ ? r.removeAttribute(l) : r[l] = null, n.push(o))
            }
        }
    }), f.fn.extend({
        text: function (e) {
            ...
            if (d && (n = (l = f.buildFragment(e, this[0].ownerDocument, !1, this)).firstChild, 1 === l.childNodes.length && (l = n), n)) {
                ...
                if (o) for (s = a[a.length - 1].ownerDocument, f.map(a, xe), u = 0; u < o; u++) r = a[u], fe.test(r.type || "") && !f._data(r, "globalEval") && f.contains(s, r) && (r.src ? f._evalUrl && f._evalUrl(r.src) : f.globalEval((r.text || r.textContent || r.innerHTML || "").replace(pe, "")));
                l = n = null
            }
            return this
        }
    ...
    function Se(e) {
        var t = C, n = Ee[e];
        return n || ("none" !== (n = ke(e, t)) && n || ((t = ((Ne = (Ne || f("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0].contentWindow || Ne[0].contentDocument).document).write(), t.close(), n = ke(e, t), Ne.detach()), Ee[e] = n), n
    }
    ...
    !function () {
        ...
        c.shrinkWrapBlocks = function () {
            ...
            e = !1;
            var t, n, r;
            return (n = C.getElementsByTagName("body")[0]) && n.style ? (t = C.createElement("div"), (r = C.createElement("div")).style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", n.appendChild(r).appendChild(t), typeof t.style.zoom !== _ && (t.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1", t.appendChild(C.createElement("div")).style.width = "5px", e = 3 !== t.offsetWidth), n.removeChild(r), e) : void 0
        }
    }();
    var Ae, De, je = /^margin/, Le = new RegExp("^(" + W + ")(?!px)[a-z%]+$", "i"), He = /^(top|right|bottom|left)$/;
    e.getComputedStyle ? (Ae = function (t) {
        return t.ownerDocument.defaultView.opener ? t.ownerDocument.defaultView.getComputedStyle(t, null) : e.getComputedStyle(t, null)
    }, De = function (e, t, n) {
        var r, i, o, a, s = e.style;
        return a = (n = n || Ae(e)) ? n.getPropertyValue(t) || n[t] : void 0, n && ("" !== a || f.contains(e.ownerDocument, e) || (a = f.style(e, t)), Le.test(a) && je.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 === a ? a : a + ""
    }) : C.documentElement.currentStyle && (Ae = function (e) {
        return e.currentStyle
    }, De = function (e, t, n) {
        var r, i, o, a, s = e.style;
        return null == (a = (n = n || Ae(e)) ? n[t] : void 0) && s && s[t] && (a = s[t]), Le.test(a) && !He.test(t) && (r = s.left, (o = (i = e.runtimeStyle) && i.left) && (i.left = e.currentStyle.left), s.left = "fontSize" === t ? "1em" : a, a = s.pixelLeft + "px", s.left = r, o && (i.left = o)), void 0 === a ? a : a + "" || "auto"
    });
    ...
    var _e = /alpha\([^)]*\)/i, Me = /opacity\s*=\s*([^)]*)/, Fe = /^(none|table(?!-c[ea]).+)/,
        Oe = new RegExp("^(" + W + ")(.*)$", "i"), Be = new RegExp("^([+-])=(" + W + ")", "i"),
        Pe = {position: "absolute", visibility: "hidden", display: "block"},
        Re = {letterSpacing: "0", fontWeight: "400"}, We = ["Webkit", "O", "Moz", "ms"];

    function $e(e, t) {
        if (t in e) return t;
        for (var n = t.charAt(0).toUpperCase() + t.slice(1), r = t, i = We.length; i--;) if ((t = We[i] + n) in e) return t;
        return r
    }

    function ze(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; a < s; a++) (r = e[a]).style && (o[a] = f._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && z(r) && (o[a] = f._data(r, "olddisplay", Se(r.nodeName)))) : (i = z(r), (n && "none" !== n || !i) && f._data(r, "olddisplay", i ? n : f.css(r, "display"))));
    ...
    function Ue(e, t, n) {
        var r = !0, i = "width" === t ? e.offsetWidth : e.offsetHeight, o = Ae(e),
            a = c.boxSizing && "border-box" === f.css(e, "boxSizing", !1, o);
        if (i <= 0 || null == i) {
            if (((i = De(e, t, o)) < 0 || null == i) && (i = e.style[t]), Le.test(i)) return i;
    ...
    f.extend({
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = f.camelCase(t), l = e.style;
                if (t = f.cssProps[s] || (f.cssProps[s] = $e(l, s)), a = f.cssHooks[t] || f.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : l[t];
                if ("string" === (o = typeof n) && (i = Be.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(f.css(e, t)), o = "number"), null != n && n == n && ("number" !== o || f.cssNumber[s] || (n += "px"), c.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), !(a && "set" in a && void 0 === (n = a.set(e, n, r))))) try {
                    l[t] = n
                } catch (e) {
                }
            }
        ...
        css: function (e, t, n, r) {
            ...
            return t = f.cssProps[s] || (f.cssProps[s] = $e(e.style, s)), (a = f.cssHooks[t] || f.cssHooks[s]) && "get" in a && (o = a.get(e, !0, n)), void 0 === o && (o = De(e, t, r)), "normal" === o && t in Re && (o = Re[t]), "" === n || n ? (i = parseFloat(o), !0 === n || f.isNumeric(i) ? i || 0 : o) : o
        }
    }), f.each(["height", "width"], function (e, t) {
        f.cssHooks[t] = {
            get: function (e, n, r) {
                if (n) return Fe.test(f.css(e, "display")) && 0 === e.offsetWidth ? f.swap(e, Pe, function () {
                    return Ue(e, t, r)
                }) : Ue(e, t, r)
            }, set: function (e, n, r) {
                var i = r && Ae(e);
                return Ie(0, n, r ? Xe(e, t, r, c.boxSizing && "border-box" === f.css(e, "boxSizing", !1, i), i) : 0)
            }
        }
        ...
        get: function (e, t) {
            ...
            var n = e.style, r = e.currentStyle, i = f.isNumeric(t) ? "alpha(opacity=" + 100 * t + ")" : "",
                o = r && r.filter || n.filter || "";
            n.zoom = 1, (t >= 1 || "" === t) && "" === f.trim(o.replace(_e, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === t || r && !r.filter) || (n.filter = _e.test(o) ? o.replace(_e, i) : o + " " + i)
        }
    }), f.cssHooks.marginRight = qe(c.reliableMarginRight, function (e, t) {
        if (t) return f.swap(e, {display: "inline-block"}, De, [e, "marginRight"])
        ...
        css: function (e, t) {
            return I(this, function (e, t, n) {
                var r, i, o = {}, a = 0;
                if (f.isArray(t)) {
                    for (r = Ae(e), i = t.length; a < i; a++) o[t[a]] = f.css(e, t[a], !1, r);
                    return o
                }
    ...
    f.Tween = Ve, (Ve.prototype = {
        constructor: Ve, init: function (e, t, n, r, i, o) {
            ...
            return this.options.duration ? this.pos = t = f.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : this.pos = t = e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : Ve.propHooks._default.set(this), this
        }
    ...
    }, f.fx = Ve.prototype.init, f.fx.step = {};
    var Je, Ye, Ge = /^(?:toggle|show|hide)$/, Qe = new RegExp("^(?:([+-])=|)(" + W + ")([a-z%]*)$", "i"),
        Ke = /queueHooks$/, Ze = [function (e, t, n) {
            var r, i, o, a, s, l, u, d = this, p = {}, h = e.style, m = e.nodeType && z(e), g = f._data(e, "fxshow");
            ...
            1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [h.overflow, h.overflowX, h.overflowY], u = f.css(e, "display"), "inline" === ("none" === u ? f._data(e, "olddisplay") || Se(e.nodeName) : u) && "none" === f.css(e, "float") && (c.inlineBlockNeedsLayout && "inline" !== Se(e.nodeName) ? h.zoom = 1 : h.display = "inline-block"));
            ...
            if (f.isEmptyObject(p)) "inline" === ("none" === u ? Se(e.nodeName) : u) && (h.display = u); else {
                ...
                for (r in p) a = rt(m ? g[r] : 0, r, d), r in g || (g[r] = a.start, m && (a.end = a.start, a.start = "width" === r || "height" === r ? 1 : 0))
            }
        }], et = {
            "*": [function (e, t) {
                var n = this.createTween(e, t), r = n.cur(), i = Qe.exec(t), o = i && i[3] || (f.cssNumber[e] ? "" : "px"),
                    a = (f.cssNumber[e] || "px" !== o && +r) && Qe.exec(f.css(n.elem, e)), s = 1, l = 20;
                if (a && a[3] !== o) {
                    o = o || a[3], i = i || [], a = +r || 1;
                    do {
    ...
    function rt(e, t, n) {
        for (var r, i = (et[t] || []).concat(et["*"]), o = 0, a = i.length; o < a; o++) if (r = i[o].call(n, t, e)) return r
    }

    function it(e, t, n) {
        var r, i, o = 0, a = Ze.length, s = f.Deferred().always(function () {
            delete l.elem
        }), l = function () {
            if (i) return !1;
            for (var t = Je || tt(), n = Math.max(0, u.startTime + u.duration - t), r = 1 - (n / u.duration || 0), o = 0, a = u.tweens.length; o < a; o++) u.tweens[o].run(r);
        ...
        for (!function (e, t) {
            var n, r, i, o, a;
            for (n in e) if (i = t[r = f.camelCase(n)], o = e[n], f.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (a = f.cssHooks[r]) && "expand" in a) {
                o = a.expand(o), delete e[r];
                for (n in o) n in e || (e[n] = o[n], t[n] = i)
            } else t[r] = i
        }(c, u.opts.specialEasing); o < a; o++) if (r = Ze[o].call(u, e, c, u.opts)) return r;
        return f.map(c, rt, u), f.isFunction(u.opts.start) && u.opts.start.call(e, u), f.fx.timer(f.extend(l, {
            elem: e,
            anim: u,
            queue: u.opts.queue
    ...
    f.Animation = f.extend(it, {
        tweener: function (e, t) {
            ...
            for (var n, r = 0, i = e.length; r < i; r++) n = e[r], et[n] = et[n] || [], et[n].unshift(t)
        ...
        fadeTo: function (e, t, n, r) {
            ...
            var i = f.isEmptyObject(e), o = f.speed(t, n, r), a = function () {
            ...
            return "string" != typeof e && (n = t, t = e, e = void 0), t && !1 !== e && this.queue(e || "fx", []), this.each(function () {
                var t = !0, i = null != e && e + "queueHooks", o = f.timers, a = f._data(this);
            ...
            return !1 !== e && (e = e || "fx"), this.each(function () {
                var t, n = f._data(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = f.timers,
                    a = r ? r.length : 0;
        ...
        var e, t, n, r, i;
        (t = C.createElement("div")).setAttribute("className", "t"), t.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", r = t.getElementsByTagName("a")[0], i = (n = C.createElement("select")).appendChild(C.createElement("option")), e = t.getElementsByTagName("input")[0], r.style.cssText = "top:1px", c.getSetAttribute = "t" !== t.className, c.style = /top/.test(r.getAttribute("style")), c.hrefNormalized = "/a" === r.getAttribute("href"), c.checkOn = !!e.value, c.optSelected = i.selected, c.enctype = !!C.createElement("form").enctype, n.disabled = !0, c.optDisabled = !i.disabled, (e = C.createElement("input")).setAttribute("value", ""), c.input = "" === e.getAttribute("value"), e.value = "t", e.setAttribute("type", "radio"), c.radioValue = "t" === e.value
    }();
    var ot = /\r/g;
    f.fn.extend({
        val: function (e) {
            var t, n, r, i = this[0];
            {
                if (arguments.length) return r = f.isFunction(e), this.each(function (n) {
                    var i;
                ...
                if (i) return (t = f.valHooks[i.type] || f.valHooks[i.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(i, "value")) ? n : "string" == typeof(n = i.value) ? n.replace(ot, "") : null == n ? "" : n
            }
        }
    }), f.extend({
        valHooks: {
            option: {
                ...
                get: function (e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || i < 0, a = o ? null : [], s = o ? i + 1 : r.length, l = i < 0 ? s : o ? i : 0; l < s; l++) if (((n = r[l]).selected || l === i) && (c.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !f.nodeName(n.parentNode, "optgroup"))) {
                        if (t = f(n).val(), o) return t;
                        a.push(t)
                    }
                    return a
                }, set: function (e, t) {
                    for (var n, r, i = e.options, o = f.makeArray(t), a = i.length; a--;) if (r = i[a], f.inArray(f.valHooks.option.get(r), o) >= 0) try {
                        r.selected = n = !0
                    } catch (e) {
                        r.scrollHeight
                    } else r.selected = !1;
    ...
    var at, st, lt = f.expr.attrHandle, ut = /^(?:checked|selected)$/i, ct = c.getSetAttribute, ft = c.input;
    f.fn.extend({
        attr: function (e, t) {
        ...
        attr: function (e, t, n) {
            ...
            if (e && 3 !== o && 8 !== o && 2 !== o) return typeof e.getAttribute === _ ? f.prop(e, t, n) : (1 === o && f.isXMLDoc(e) || (t = t.toLowerCase(), r = f.attrHooks[t] || (f.expr.match.bool.test(t) ? st : at)), void 0 === n ? r && "get" in r && null !== (i = r.get(e, t)) ? i : null == (i = f.find.attr(e, t)) ? void 0 : i : null !== n ? r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : void f.removeAttr(e, t))
        }, removeAttr: function (e, t) {
            var n, r, i = 0, o = t && t.match(A);
            if (o && 1 === e.nodeType) for (; n = o[i++];) r = f.propFix[n] || n, f.expr.match.bool.test(n) ? ft && ct || !ut.test(n) ? e[r] = !1 : e[f.camelCase("default-" + n)] = e[r] = !1 : f.attr(e, n, ""), e.removeAttribute(ct ? n : r)
        }, attrHooks: {
            type: {
                set: function (e, t) {
    ...
    var dt = /^(?:input|select|textarea|button|object)$/i, pt = /^(?:a|area)$/i;
    f.fn.extend({
        prop: function (e, t) {
    ...
    f.fn.extend({
        addClass: function (e) {
            ...
            if (u) for (t = (e || "").match(A) || []; s < l; s++) if (r = 1 === (n = this[s]).nodeType && (n.className ? (" " + n.className + " ").replace(ht, " ") : " ")) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : f.isFunction(e) ? this.each(function (n) {
                ...
                if ("string" === n) for (var t, r = 0, i = f(this), o = e.match(A) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else n !== _ && "boolean" !== n || (this.className && f._data(this, "__className__", this.className), this.className = this.className || !1 === e ? "" : f._data(this, "__className__") || "")
            })
        }, hasClass: function (e) {
            for (var t = " " + e + " ", n = 0, r = this.length; n < r; n++) if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(ht, " ").indexOf(t) >= 0) return !0;
            return !1
        }
    ...
    f.parseJSON = function (t) {
        ...
        return i && !f.trim(i.replace(vt, function (e, t, i, o) {
    ...
    function Dt(e) {
        return function (t, n) {
            ...
            if (f.isFunction(n)) for (; r = o[i++];) "+" === r.charAt(0) ? (r = r.slice(1) || "*", (e[r] = e[r] || []).unshift(n)) : (e[r] = e[r] || []).push(n)
        }
    }
    ...
    f.extend({
        ...
        ajax: function (e, t) {
            ...
            var n, r, i, o, a, s, l, u, c = f.ajaxSetup({}, t), d = c.context || c,
                p = c.context && (d.nodeType || d.jquery) ? f(d) : f.event, h = f.Deferred(),
                m = f.Callbacks("once memory"), g = c.statusCode || {}, v = {}, y = {}, b = 0, x = "canceled", w = {
                    readyState: 0, getResponseHeader: function (e) {
                        var t;
                        if (2 === b) {
                            if (!u) for (u = {}; t = Tt.exec(o);) u[t[1].toLowerCase()] = t[2];
                            t = u[e.toLowerCase()]
                        }
            ...
            if (h.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, c.url = ((e || c.url || bt) + "").replace(xt, "").replace(Nt, yt[1] + "//"), c.type = t.method || t.type || c.method || c.type, c.dataTypes = f.trim(c.dataType || "*").toLowerCase().match(A) || [""], null == c.crossDomain && (n = Et.exec(c.url.toLowerCase()), c.crossDomain = !(!n || n[1] === yt[1] && n[2] === yt[2] && (n[3] || ("http:" === n[1] ? "80" : "443")) === (yt[3] || ("http:" === yt[1] ? "80" : "443")))), c.data && c.processData && "string" != typeof c.data && (c.data = f.param(c.data, c.traditional)), jt(kt, c, t, w), 2 === b) return w;
            (s = f.event && c.global) && 0 == f.active++ && f.event.trigger("ajaxStart"), c.type = c.type.toUpperCase(), c.hasContent = !Ct.test(c.type), i = c.url, c.hasContent || (c.data && (i = c.url += (gt.test(i) ? "&" : "?") + c.data, delete c.data), !1 === c.cache && (c.url = wt.test(i) ? i.replace(wt, "$1_=" + mt++) : i + (gt.test(i) ? "&" : "?") + "_=" + mt++)), c.ifModified && (f.lastModified[i] && w.setRequestHeader("If-Modified-Since", f.lastModified[i]), f.etag[i] && w.setRequestHeader("If-None-Match", f.etag[i])), (c.data && c.hasContent && !1 !== c.contentType || t.contentType) && w.setRequestHeader("Content-Type", c.contentType), w.setRequestHeader("Accept", c.dataTypes[0] && c.accepts[c.dataTypes[0]] ? c.accepts[c.dataTypes[0]] + ("*" !== c.dataTypes[0] ? ", " + At + "; q=0.01" : "") : c.accepts["*"]);
    ...
    function Ot(e, t, n, r) {
        ...
        if (f.isArray(t)) f.each(t, function (t, i) {
            n || qt.test(e) ? r(e, i) : Ot(e + "[" + ("object" == typeof i ? t : "") + "]", i, n, r)
        }); else if (n || "object" !== f.type(t)) r(e, t); else for (i in t) Ot(e + "[" + i + "]", t[i], n, r)
    }
    ...
    f.param = function (e, t) {
        ...
        serialize: function () {
            ...
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !f(this).is(":disabled") && Ft.test(this.nodeName) && !Mt.test(e) && (this.checked || !X.test(e))
            }).map(function (e, t) {
                var n = f(this).val();
    ...
    var Bt = 0, Pt = {}, Rt = f.ajaxSettings.xhr();
    e.attachEvent && e.attachEvent("onunload", function () {
        for (var e in Pt) Pt[e](void 0, !0)
    }), c.cors = !!Rt && "withCredentials" in Rt, (Rt = c.ajax = !!Rt) && f.ajaxTransport(function (e) {
            ...
            return {
                send: function (n, r) {
                    ...
                    o.send(e.hasContent && e.data || null), t = function (n, i) {
                        var s, l, u;
                        if (t && (i || 4 === o.readyState)) if (delete Pt[a], t = void 0, o.onreadystatechange = f.noop, i) 4 !== o.readyState && o.abort(); else {
    ...
    f.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = f.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(zt, "$1" + i) : !1 !== t.jsonp && (t.url += (gt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
            return a || f.error(i + " was not called"), a[0]
        }, t.dataTypes[0] = "json", o = e[i], e[i] = function () {
            a = arguments
        }, r.always(function () {
            e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, $t.push(i)), a && f.isFunction(o) && o(a[0]), a = o = void 0
        }), "script"
    ...
    f.offset = {
        setOffset: function (e, t, n) {
            var r, i, o, a, s, l, u = f.css(e, "position"), c = f(e), d = {};
        ...
        offset: function (e) {
            ...
            if (o) return t = o.documentElement, f.contains(t, i) ? (typeof i.getBoundingClientRect !== _ && (r = i.getBoundingClientRect()), n = Ut(o), {
            ...
            return this.map(function () {
                for (var e = this.offsetParent || Xt; e && !f.nodeName(e, "html") && "static" === f.css(e, "position");) e = e.offsetParent;
                return e || Xt
            })
        }
        ...
        f.cssHooks[t] = qe(c.pixelPosition, function (e, n) {
            if (n) return n = De(e, t), Le.test(n) ? f(e).position()[t] + "px" : n
        })
