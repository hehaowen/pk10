...
function red_bag_html_(red_site_domain,pic,skin){
    ...
    red_bag_html+="                            <p id=\"list_fail\" class=\"red_p hide\"><span>加入红包队列失败<br><br>请咨询在线客服！</span></p>";
    red_bag_html+="                            <p id=\"list_success\" class=\"red_p hide\"><span style='font-size: 20px'>恭喜抢到</span><span id=\"redmoney\" style='style='font-size: 24px''>0</span><span>元</span><br><br><span style='font-family:Fantasy'>金额</span><span st>会在三到五分钟后到账</span></p>";
    red_bag_html+="                            <p id=\"out_red\" class=\"red_p hide\"><span>红包派发中,请耐心等待!</span></p>";
                    ...
                    $("#red_sp").click(function(){
                        ...
                        $.get(red_site_domain+"/index.php/games/red/snatch", {"rid":_this.gameslist[0].id},
                            ...
                            if("success" === status ){
                               ...
                               if(data.Code == 0){
                                 $(".red_p").addClass("hide");
                                 $("#list_success").removeClass("hide");
                                 $("#list_success #redmoney").html(parseFloat(data.red.money).toFixed(2))
                               }else if(data.Code == 1){
                                 $("#list_success").addClass("hide");
                                ...
                                $(".red_p").addClass("hide");
                                $('#list_success').removeClass("hide");
                                $("#redmoney").html(parseFloat(data.red.money).toFixed(2))
                                $(".red_a").hide();
                               }else if(data.Code == 26){
                                $(".red_p").addClass("hide");
                                $('#list_fail').removeClass("hide");
                                $(".red_a").hide();
                               }else if(data.Code == 27){
                                $(".red_p").addClass("hide");
                                $('#out_red').removeClass("hide");
                                $(".red_a").hide();
